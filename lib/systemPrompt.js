...
===STATUS===
[Album name] · Track [X of Y] · Next: [title or "End of album"] · Mode: [mode]
===
...
export function modeNote(mode) {
  if (mode === 'commute') {
    return '\n\nMODE — Commute: Tighter breakdowns. Focus on emotional centre and 1 to 2 key craft points. Keep under 2 minutes even for core songs.';
  }
  if (mode === 'reentry') {
    return '\n\nMODE — Re-entry: Begin with a 45 second recap of where we are in the album arc, then continue normally.';
  }
